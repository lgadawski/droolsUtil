...
public final class Statements {
     ...
     * 
     */
    static final String DELETE_CHILD_LEFT_TUPLES = "delete from left_tuples where parent_right_tuple_id = ?";
    /**
     * 
     */
     ...
     * 
     */
    static final String DELETE_FACT_HANDLE = "delete from fact_handles where fact_handle_id = ?";
    /**
     * 
     */
     ...
     */
    static final String INSERT_INTO_FACT_HANDLES = "UPDATE fact_handles SET object = ? WHERE fact_handle_id = ?;"
     ...
     * 
     */
    static final String UPDATE_RIGHT_TUPLE = "UPDATE right_tuples SET object = ? where right_tuple_id = ?";
